...
#go build -tags android -ldflags=-w -trimpath -o build/android/armeabi-v7a/libmobile.so -buildmode c-shared
...
#go build -tags android -ldflags=-w -trimpath -o build/android/arm64-v8a/libmobile.so -buildmode c-shared
...
#go build -tags android -ldflags=-w -trimpath -o build/android/x86/libmobile.so -buildmode c-shared
...
#go build -tags android -ldflags=-w -trimpath -o build/android/x86_64/libmobile.so -buildmode c-shared